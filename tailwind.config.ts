  ...
  theme: {
    extend: {
      colors: {
        ...
        'crown-rose':      'oklch(72% 0.061 51 / <alpha-value>)',
        'crown-rose2':     'oklch(84% 0.043 50 / <alpha-value>)',
        'crown-rose-dark': 'oklch(54% 0.057 45 / <alpha-value>)',
        'crown-rose-deep': 'oklch(15% 0.025 48 / <alpha-value>)',
        'crown-rose-ink':  'oklch(32% 0.032 47 / <alpha-value>)',
